    ...
    func AlamoFireRequest(rp: requestParameters,completed:@escaping (_ resJson : Any?, _ error : Error?) -> Void) {
        ...
        case .none:
            ...
            Alamofire.request(rp.url, method:rp.method, parameters: rp.parameters).validate().responseJSON { response in
                ...
                case .success:
//                    print ("#########################suc : \(rp.url)###############################")
//                    print("HttpHandler : .none Successful Value: \(String(describing: response.result.value))")
//                    print("HttpHandler : .none Successful Data: \(String(describing: response.data))")
...
//            print(rp.parameters)
            ...
            Alamofire.request(rp.url, method:rp.method, parameters: rp.parameters, headers: rp.headers).validate().responseJSON { response in
                ...
                case .success:
//                    print ("#########################suc : \(rp.url)###############################")
//                    print("HttpHandler : .some Successful : \(String(describing: response.result.value))")
//
...
//        if img != nil
//        {
//            data = UIImagePNGRepresentation(img!) as! Data
//        }
